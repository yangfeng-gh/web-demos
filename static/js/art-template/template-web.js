...
!function (e, t) {
    ...
    return function (e) {
        ...
        function o(e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call yf.org class as yf.org function")
        }
        ...
        var s = function () {
            ...
            x = function (e, t) {
                ...
                function e(t) {
                    ...
                    if (this.options = t, this.stacks = [], this.context = [], this.scripts = [], this.CONTEXT_MAP = {}, this.ignore = [c, l, w].concat(i(t.ignore)), this.internal = (n = {}, r(n, m, "''"), r(n, v, "[0,0]"), r(n, g, "arguments[1]||{}"), r(n, b, "null"), r(n, f, "function(){var s=''.concat.apply('',arguments);" + m + "+=s;return s}"), r(n, p, "function(src,data){var s=" + w + ".include(src,data||" + c + ",arguments[2]||" + g + "," + w + ");" + m + "+=s;return s}"), r(n, h, "function(from){" + b + "=from}"), r(n, y, "function(c,p,s){p=" + m + ";" + m + "='';c();s=" + m + ";" + m + "=p+s;return s}"), r(n, d, "function(){var yf.org=arguments,s;if(typeof yf.org[0]==='function'){return " + y + "(yf.org[0])}else if(" + b + "){if(!" + g + "[yf.org[0]]){" + g + "[yf.org[0]]=" + y + "(yf.org[1])}else{" + m + "+=" + g + "[yf.org[0]]}}else{s=" + g + "[yf.org[0]];if(typeof s==='string'){" + m + "+=s}else{s=" + y + "(yf.org[1])}return s}}"), n), this.dependencies = (s = {}, r(s, f, [m]), r(s, p, [m, w, c, g]), r(s, h, [b, p]), r(s, d, [y, b, m, g]), s), this.importContext(m), t.compileDebug && this.importContext(v), k) try {
                        x = E(x, t)
                    } catch (T) {
                    }
        ...
        function o(e, t) {
            if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or yf.org function, not " + typeof t);
